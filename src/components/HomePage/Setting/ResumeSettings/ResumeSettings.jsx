...
export default function ResumeSettings() {
  ...
  const handleAdd = async () => {
    ...
    try {
      const response = await fetch('https://gitshow-production.up.railway.app/api/resumes', {
        method: 'POST',
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await fetch(`https://gitshow-production.up.railway.app/api/resumes/${formData.id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const handleDelete = async (id) => {
    try {
      const response = await fetch(`https://gitshow-production.up.railway.app/api/resumes/${id}`, {
        method: 'DELETE',
      });
  ...
  const handleExperienceUpdate = async () => {
    try {
      const response = await fetch('https://gitshow-production.up.railway.app/api/user', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        credentials: 'include',
